...
Not an origin storym that's moved to the primer.
...
The manifesto should be short and sweet as good manifestos
should always be.  And then backed up by additional in-depth texts
