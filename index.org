...
there are always power imbalences within packs, but if the
pack stays small those power imbalences are largely
compensated for by the other members of the pack.  But when
you try to scale a pack, those power imbalences are
