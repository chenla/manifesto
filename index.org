...
Theses are declarations that will provide a foundation for
a =civil ruleset= for people to live and cooperate with each
other.  A theses is a social fiction that is collectively
believed in.  It defines how we want to live and behave with
each other.
