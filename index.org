...
Our language will be called: 

  - A Pace-Layer Pattern Language (APPL), ???
  
which will be made up of seven parts:
...
/Nature/ at the bottom being the slowest and /Fashion/ at
the top in a constant state of churn, changing at a staccato
rapid-fire beat.

We added a 7th group called /Meta/ for patterns
that apply to all layers which will be given the number 0
below /nature/ which is number 1.
...
We divide nature into the realms of the physical universe
and the subset of that and the tiny subset of that that
makes up the living universe.
...
thinking of things in terms of us vs them, nature knows no
such divisions.  We can not become one with nature, because
we were never apart from nature in the first place.
...
more biospheres, both planetary and artificial.
