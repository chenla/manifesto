...
The other thing is that the emergence of man and how
civilization emerged is still using the same traditional
idea of civilization arising suddenly after adoption of
agriculture.  It does not deal with any of the new evidence
that has been piling up over the past 20 years that paints a
very different picture.  And ignores the fact that states
(which are the define and demarcate civilization) were,
until the past 200 years, little more than tiny islands that
under went continious cycles of boom, bust and abandonment
which are more often than not dumped under the collective
ruberic of /dark ages/.  The implication is that dark is
bad, a step backwards, when in fact it is literaly just a
dearth of information because little or nothing has survived
from those periods.
...
The prologomenon will now server several purposes: 
